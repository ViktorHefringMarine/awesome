...
globalkeys = my_table.join(
	...
	awful.key({ modkey }, "d", function()
		awful.spawn(
			string.format(
				"rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/awesome/rofi/launcher2.rasi",
				beautiful.bg_normal,
				beautiful.fg_normal,
				beautiful.bg_focus,
				beautiful.fg_focus
	...
	end, { description = editorgui, group = "function keys" }),
	...
	awful.key({ modkey }, "F12", function()
		-- awful.util.spawn("fd --base-directory /usr/share/X11/xkb/symbols --max-depth=1 --type=f | dmenu_run | xargs -I {} setxkbmap {} -option altwin:swap_alt_win")
		awful.util.spawn_with_shell("fd --base-directory /usr/share/X11/xkb/symbols --max-depth=1 --type=f  | dmenu | xargs -I {} setxkbmap {} -option altwin:swap_alt_win")
		-- awful.util.spawn_with_shell("ls | dmenu_run | xargs -I {} setxkbmap {} -option altwin:swap_alt_win")
	end, { description = "Select keyboard layout", group = "function keys" }),

	-- super + ...
	awful.key({ modkey, ctrlkey }, "c", function()
		awful.util.spawn("conky-toggle")
	end, { description = "conky-toggle", group = "super" }),

	-- awful.key({ modkey, ctrlkey }, "c", function()
	-- 	awful.util.spawn("killall conky")
	-- end, { description = "conky killall", group = "super" }),
	...
	-- super + shift + ...
	awful.key({ modkey, ctrlkey }, "Return", function()
		awful.util.spawn(filemanager)
	...
	awful.key({ altkey, shiftkey }, "n", function()
	...
	awful.key({ altkey, shiftkey }, "u", function()
	...
	awful.key({ altkey, shiftkey }, "p", function()
	...
	awful.key({ modkey, shiftkey }, "p", function()
		awful.prompt.run({
			...
			exe_callback = function(image_name)
				awful.util.spawn("xfce4-screenshooter -f -s hm/images/" .. image_name .. ".png")
			end,
			history_path = awful.util.get_cache_dir() .. "/history_eval",
		})
	end, { description = "screenshot to ~/hm/images", group = "images" }),

	awful.key({ modkey, shiftkey }, "i", function()
		awful.util.spawn("rofi -show filebrowser")
	end, { description = "open", group = "images" }),
	...
	-- I removed this
	-- awful.key({ modkey, shiftkey }, "Left", awful.tag.viewprev, { description = "view previous", group = "tag" }),
	-- awful.key({ modkey, shiftkey }, "Right", awful.tag.viewnext, { description = "view next", group = "tag" }),
	...
	awful.key({ modkey }, "Right", function()
		awful.client.focus.byidx(1)
	end, { description = " - gt next", group = "client[idx]" }),

	awful.key({ modkey }, "Left", function()
		awful.client.focus.byidx(-1)
	end, { description = " - gt prev", group = "client[idx]" }),
	...
	end, { description = " - gt last", group = "client[idx]" }),
	...
	end, { description = " - sw next", group = "client[idx]" }),

	awful.key({ modkey, shiftkey }, "Left", function()
		awful.client.swap.byidx(-1)
	end, { description = "swap prev", group = "client[idx]" }),
	...
	end, { description = " - gt down", group = "client" }),
	awful.key({ modkey }, "k", function()
		awful.client.focus.global_bydirection("up")
		if client.focus then
			client.focus:raise()
		end
	end, { description = " - gt up", group = "client" }),
	awful.key({ modkey }, "h", function()
		awful.client.focus.global_bydirection("left")
		if client.focus then
			client.focus:raise()
		end
	end, { description = " - gt left", group = "client" }),
	awful.key({ modkey }, "l", function()
		awful.client.focus.global_bydirection("right")
		if client.focus then
			client.focus:raise()
		end
	end, { description = " - gt right", group = "client" }),
	...
	end, { description = "- inc master width", group = "layout" }),
	awful.key({ modkey, shiftkey }, "h", function()
		awful.tag.incmwfact(-0.005)
	end, { description = "- dec master width", group = "layout" }),

	awful.key({ altkey, shiftkey }, "h", function()
		awful.tag.incnmaster(1, nil, true)
	end, { description = "  - inc num of masters", group = "layout" }),
	awful.key({ altkey, shiftkey }, "l", function()
		awful.tag.incnmaster(-1, nil, true)
	end, { description = "  - dec num of masters", group = "layout" }),

	awful.key({ modkey, ctrlkey }, "h", function()
		awful.tag.incncol(1, nil, true)
	end, { description = " - inc num of cols", group = "layout" }),
	awful.key({ modkey, ctrlkey }, "l", function()
		awful.tag.incncol(-1, nil, true)
	end, { description = " - dec num of cols", group = "layout" }),

	-- Select Layout
	awful.key({ modkey }, "space", function()
		awful.layout.inc(1)
	end, { description = " - next", group = "layout [type]" }),

	awful.key({ modkey, ctrlkey }, "t", function()
		awful.layout.set(awful.layout.suit.tile)
	end, { description = "- tile", group = "layout [type]" }),

	awful.key({ modkey, ctrlkey }, "f", function()
		awful.layout.set(awful.layout.suit.floating)
	end, { description = "- float", group = "layout [type]" }),

	awful.key({ modkey, ctrlkey }, "m", function()
		awful.layout.set(awful.layout.suit.max)
	end, { description = "- max", group = "layout [type]" }),
	...
	awful.key({ modkey }, "F7", function()
		awful.util.spawn("bluetoothctl connect 38:18:4C:EA:18:D9")
	end, { description = "bluetoothctl connect ", group = "Audio" }),
...
clientkeys = my_table.join(
	...
	awful.key({ modkey, shiftkey }, "Return", function(c)
		c:swap(awful.client.getmaster())
	end, { description = "move to master", group = "client" }),

	-- awful.key({ modkey, shiftkey   }, "Left",   function (c) c:move_to_screen()               end,
	--           {description = "move to screen", group = "client"}),
	-- awful.key({ modkey, shiftkey   }, "Right",  function (c) c:move_to_screen()               end,
	--           {description = "move to screen", group = "client"}),
